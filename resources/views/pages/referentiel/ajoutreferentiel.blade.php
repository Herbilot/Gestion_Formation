            ...
            <div class="col-lg-6">
                ...
                <form method="post" action="{{url('referentiels/enregistrer')}}">
                    ...
                    <div class="form-group">
                        ...
                        <input name="libelle" type="text" class="form-control" id="libelle" placeholder="Entrez le nom du référentiel"
                        value="{{old('libelle')}}">
                        @error('libelle')
                    ...
                    <div class="form-group">
                        ...
                        <input name="horaire" type="number" class="form-control" id="horaire" placeholder="40"
                        value="{{old('horaire')}}">
                        @error('type')
                        <div class="alert alert-danger" role="alert">
                        {{$message}}
